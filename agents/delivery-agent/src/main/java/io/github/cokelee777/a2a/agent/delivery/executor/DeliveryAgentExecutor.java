package io.github.cokelee777.a2a.agent.delivery.executor;
...
/**
 * A2A {@link AgentExecutor} for the Delivery Agent.
 *
 * <p>
...
public class DeliveryAgentExecutor implements AgentExecutor {
	 ...
	 */
	public DeliveryAgentExecutor(List<SkillExecutor> executors) {
	...
	public void execute(RequestContext context, EventQueue eventQueue) throws JSONRPCError {
		...
		log.debug("DeliveryAgentExecutor: skillId={}, text={}", skillId, text);
		...
		try {
			...
			log.error("DeliveryAgentExecutor error: {}", e.getMessage(), e);
