package io.github.cokelee777.a2a.agent.order.executor;
...
/**
 * A2A {@link AgentExecutor} for the Order Agent.
 *
 * <p>
...
public class OrderAgentExecutor implements AgentExecutor {
	 ...
	 */
	public OrderAgentExecutor(List<SkillExecutor> executors) {
	...
	public void execute(RequestContext context, EventQueue eventQueue) throws JSONRPCError {
		...
		log.debug("OrderAgentExecutor: skillId={}, text={}", skillId, text);
		...
		try {
			...
			log.error("OrderAgentExecutor error: {}", e.getMessage(), e);
