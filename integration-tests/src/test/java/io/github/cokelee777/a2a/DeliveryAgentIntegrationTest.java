package io.github.cokelee777.a2a;

import io.a2a.A2A;
import io.a2a.spec.AgentCard;
import io.a2a.spec.Message;
import io.github.cokelee777.a2a.agent.delivery.DeliveryAgentApplication;
 ...
 *
 * <p>
 * Starts the full Delivery Agent Spring Boot application with a mocked
 * {@link ChatModel}, then verifies A2A protocol compliance (AgentCard endpoint) and
 * end-to-end transport via {@link A2ATransport}.
 * </p>
 */
@SpringBootTest(classes = DeliveryAgentApplication.class,
